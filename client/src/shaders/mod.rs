...
impl Plugin for ShadersPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(MaterialPlugin::<
            ExtendedMaterial<StandardMaterial, SpaceStationMaterialExtension>,
        >::default());
    }
}

#[derive(Asset, TypePath, AsBindGroup, Debug, Clone)]
pub struct SpaceStationMaterialExtension {
...
impl MaterialExtension for SpaceStationMaterialExtension {
